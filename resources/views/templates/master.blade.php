...
<html>
  <head>
    ...
    <link rel="stylesheet" href="public/dist/css/skins/skin-purple-light.min.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="public/index2.html" class="logo">
          ...
          <span class="logo-mini"><b>V</b>NB</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Admin</b>VNB</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="public/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017-2018 <a href="#">VNBees</a>.</strong>
      </footer>
    ...
    <script type="text/javascript">
      var js_data = '<?php echo json_encode($user); ?>';
      var user = JSON.parse(js_data ); 
    </script>
    @yield('js')
  </body>
</html>
